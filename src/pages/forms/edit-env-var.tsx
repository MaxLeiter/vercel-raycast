...
const EditEnvironmentVariable = ({ updateEnvVar, envVar }: Props) => {
    ...
    >
        ...
        <Form.Separator />
        <Form.Checkbox id="edit-form-production" label="Production" defaultValue={envVar.target?.includes("production")} />
        <Form.Checkbox id="edit-form-preview" label="Preview" defaultValue={envVar.target?.includes("preview")} />
        <Form.Checkbox id="edit-form-development" label="Development" defaultValue={envVar.target?.includes("development")} />
