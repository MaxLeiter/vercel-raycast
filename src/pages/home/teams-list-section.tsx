...
const TeamListSection = ({ teams, setTeam, selectedTeam }: Props) => {
    ...
    return (<List.Section title="Teams">
        <List.Item title='Switch team...' icon={Icon.Globe}
        ...
        />
        <List.Item title="Create New Team" icon={Icon.Plus} actions={
            <ActionPanel>
                <OpenInBrowserAction url={`https://vercel.com/teams/create`} icon={Icon.Link} />
            </ActionPanel>}
        />
    </List.Section>)
}
